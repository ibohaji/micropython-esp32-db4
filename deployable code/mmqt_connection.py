# -*- coding: utf-8 -*-
"""
Created on Tue Jun 13 15:49:29 2023
...
def MQTTConnect(username,io_key,feedname):
    ...
    ADAFRUIT_IO_FEEDNAME = bytes('{:s}/feeds/{:s}'.format(username, feedname), 'utf-8')    
...
def publish(data,feed,ADAFRUIT_USERNAME,client):
...
#TODO: must create logic for this part
def cb(msg):
    return int(msg)
