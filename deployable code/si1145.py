...
def set_high_gain(self):
            # Read the current value of the ALSIRADCMISC register
            reg = self._readParam(SI1145_PARAM_ALSIRADCMISC)
            # Set the RANGE bit to enable high gain mode
            reg |= SI1145_PARAM_ALSIRADCMISC_RANGE
            # Write the new value back to the ALSIRADCMISC register
            self._writeParam(SI1145_PARAM_ALSIRADCMISC, reg)
            # Read the current value of the ALSVISADCMISC register
            reg = self._readParam(SI1145_PARAM_ALSVISADCMISC)
            # Set the VISRANGE bit to enable high gain mode
            reg |= SI1145_PARAM_ALSVISADCMISC_VISRANGE
            # Write the new value back to the ALSVISADCMISC register
            self._writeParam(SI1145_PARAM_ALSVISADCMISC,reg)